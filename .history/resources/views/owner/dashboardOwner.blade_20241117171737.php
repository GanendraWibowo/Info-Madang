    ...
    <div class="d-flex align-items-center mb-4">
        <div class="dropdown me-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <li><a class="dropdown-item" href="{{ route('owner.products', ['category' => 'makanan']) }}">Makanan</a></li>
                <li><a class="dropdown-item" href="{{ route('owner.products', ['category' => 'minuman']) }}">Minuman</a></li>
                <li><a class="dropdown-item" href="{{ route('owner.products', ['category' => 'snacks']) }}">Snacks</a></li>
                <li><a class="dropdown-item" href="{{ route('owner.products', ['category' => 'PaHe']) }}">PaHe</a></li>
            </ul>
        </div>
