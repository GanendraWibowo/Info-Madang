                ...
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div class="card h-100">
                        @if($product->image)
                            ...
                            @else
                                <img src="{{ asset('storage/' . urlencode($product->image)) }}" class="card-img-top" alt="{{ $product->name }}" style="height: 200px; object-fit: cover;">
                            @endif
                        @else
                            <img src="{{ asset('img/default-product.jpg') }}" class="card-img-top" alt="{{ $product->name }}" style="height: 200px; object-fit: cover;">
                        @endif
                        <div class="card-body">
